...
// Cek apakah pengguna sudah login atau memiliki peran admin
...
if (isset($_POST['simpan'])) {
    ...
    // Pastikan ID User unik, bisa menggunakan metode tertentu, contoh menggunakan timestamp
    $id_user = "USER_" . time();
                        ...
                        <div class="col-lg-4 px-4 p-3 bg-white shadow p-3 mb-5 bg-body rounded" style="border-radius: 7px;">
                            ...
                            <form action="" method="POST" class="px-3">
                                <div class="form-group mb-2">
                                    ...
                                    <!-- ID User bisa di-generate sesuai kebutuhan, contoh menggunakan timestamp -->
                                    <input type="text" name="id_user" class="form-control" placeholder="Masukkan ID User" value="USER_<?php echo time(); ?>" readonly>
                                </div>
                                <div class="form-group mb-2">
